	...
	<body>
		...
		<div id="show-address" class="content scaffold-show" role="main">
			...
			<ol class="property-list address">
				...
				<g:if test="${addressInstance?.streetName}">
				<li class="fieldcontain">
					<span id="streetName-label" class="property-label"><g:message code="address.streetName.label" default="Street Name" /></span>
					
						<span class="property-value" aria-labelledby="streetName-label"><g:fieldValue bean="${addressInstance}" field="streetName"/></span>
				...
				<li class="fieldcontain">
					<span id="streetType-label" class="property-label"><g:message code="address.streetType.label" default="Street Type" /></span>
