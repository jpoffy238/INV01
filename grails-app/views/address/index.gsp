		...
		<div id="list-address" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="streetName" title="${message(code: 'address.streetName.label', default: 'Street Name')}" />
					
						<g:sortableColumn property="streetType" title="${message(code: 'address.streetType.label', default: 'Street Type')}" />
				...
				<g:each in="${addressInstanceList}" status="i" var="addressInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: addressInstance, field: "streetName")}</td>
					
						<td>${fieldValue(bean: addressInstance, field: "streetType")}</td>
