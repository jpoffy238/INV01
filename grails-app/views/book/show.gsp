...
<%@ page import="org.mj.example.entities.Book" %>
<!DOCTYPE html>
<html>
	<head>
			...
			<ol class="property-list book">
				...
				<li class="fieldcontain">
					<span id="author-label" class="property-label"><g:message code="book.author.label" default="Author" /></span>
						...
						<span class="property-value" aria-labelledby="author-label"><g:link controller="author" action="show" id="${bookInstance?.author?.lastName}">${bookInstance?.author?.encodeAsHTML()}</g:link></span>
				...
				<g:if test="${bookInstance?.printDate}">
				<li class="fieldcontain">
					<span id="printDate-label" class="property-label"><g:message code="book.printDate.label" default="Print Date" /></span>
					
						<span class="property-value" aria-labelledby="printDate-label"><g:fieldValue bean="${bookInstance}" field="printDate"/></span>
