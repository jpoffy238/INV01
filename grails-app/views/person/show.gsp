	...
	<body>
		...
		<div id="show-person" class="content scaffold-show" role="main">
			...
			<ol class="property-list person">
				...
				<g:if test="${personInstance?.books}">
				<li class="fieldcontain">
					<span id="books-label" class="property-label"><g:message code="person.books.label" default="Books" /></span>
					
						<g:each in="${personInstance.books}" var="b">
				...
				<g:if test="${personInstance?.dod}">
				<li class="fieldcontain">
					<span id="dod-label" class="property-label"><g:message code="person.dod.label" default="Dod" /></span>
					
						<span class="property-value" aria-labelledby="dod-label"><g:formatDate date="${personInstance?.dod}" /></span>
